...
([
    ...
    (function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_0_f7_upscroller__ = __webpack_require__(1);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_0_f7_upscroller___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_f7_upscroller__);
    ...
    (function(module, exports) {
        ...
        module.exports = {
            ...
            install() {
                var css = '.upscroller{-webkit-transform:translate3d(0,0,0);transform:translate3d(0,0,0);transition:-webkit-transform .5s;position:fixed;left:50%;margin-left:-47px;top:-50px;z-index:400!important;height:24px;border-radius:20px;width:100px;background:#6ac045;font-size:14px;text-align:center;padding:3px 2px 2px;color:#fff!important;cursor:pointer}.upscroller.show{-webkit-transform:translate3d(0,200px,0);transform:translate3d(0,200px,0)}';
            ...
            on: {
                pageInit: function(page) {
                    ...
                    var $$btn = $$('<div class="upscroller"><i class="icon material-icons md-only">arrow_upward</i> ' + params.text + '</div>');
                    $$(page.el).prepend($$btn);
